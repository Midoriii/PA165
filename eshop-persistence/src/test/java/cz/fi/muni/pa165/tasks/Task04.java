...
public class Task04 extends AbstractTestNGSpringContextTests {
	...
	public void leftJoinCagesWithPets() {
		...
		Assert.assertEquals(productAndCategory.size(), 4);
		...
		Assert.assertEquals(productAndCategory.get(3).getProduct().getName(),"Plate");
		Assert.assertEquals(productAndCategory.get(3).getCategory().getName(), "Kitchen");
	}
